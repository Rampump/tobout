...
class MigrationViewModelTest {
    ...
    private val testImportResult = ImportResult.Success(
    ...
    @Test
    fun `loadExportPreview is called on init and updates exportPreview`() = runTest {
        advanceUntilIdle()
    ...
    @Test
    fun `exportData sets state to Exporting then ExportComplete on success`() = runTest {
    ...
    @Test
    fun `exportData sets state to Error on failure`() = runTest {
    ...
    @Test
    fun `exportData updates progress during export`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `previewImport sets state to Loading then ImportPreview on success`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `previewImport sets state to Error on failure`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `importData sets state to Error on failure`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `importData updates progress during import`() = runTest {
        val mockUri = mockk<Uri>()
    ...
    @Test
    fun `resetState returns to Idle and clears progress`() = runTest {
        val mockUri = mockk<Uri>()
        coEvery { migrationExporter.exportData(any()) } returns Result.success(mockUri)
    ...
    @Test
    fun `cleanupExportFiles calls exporter cleanup`() = runTest {
